  ...
  foot: {
    ...
    sections:[
      ...
      { id:"f_forefoot", title:"Forefoot", fields:[
        { id:"f_bunion", label:"4. Bunion Assessment — big toe points inward and/or bump at base?", type:"passfail", options:["Pass","Fail Right","Fail Left"],
        ...
        { id:"f_hammer", label:"7. Hammer Toe — middle part of toes elevated, ends angled downward?", type:"passfail", options:["Pass","Fail Right","Fail Left"],
