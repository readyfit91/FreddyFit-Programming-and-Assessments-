    ...
    sections:[
      { id:"p8s1", title:"8 Tests", fields:[
        ...
        { id:"p8_empty_can", label:"Empty Can Test — shoulder weakness or pain", type:"passfail", options:["Pass","Fail"],
          ...
          modifiers:["AC joint clamp → AC joint instability (narrow grip, no dips/bench)","Shoulders up → Overhead presses, shrugs, downward dog","Shoulders down → Lat pulldowns, W-retractions, deadlifts","Shoulders back → Wide grip pulling (3:1 back-to-chest ratio)","No modifier helped"] },
