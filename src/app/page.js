...
const BLOOD_PANELS = [
  ...
  },
  {
    ...
    markers: [
      ...
      { name: 'Globulin',            unit: 'g/dL',  optimal: [2.0,3.5],   borderline: [1.5,2.0],  desc: 'Immune proteins and transport proteins. Low = immune deficiency; high = chronic inflammation or infection.' },
      { name: 'A/G Ratio',           unit: 'ratio', optimal: [1.2,2.2],   borderline: [1.0,1.2],  desc: 'Albumin to globulin ratio. Low ratio = elevated globulins from chronic inflammation or liver stress.' },
      ...
      { name: 'Alkaline Phosphatase',unit: 'U/L',   optimal: [40,130],    borderline: [130,200],  desc: 'Liver and bone enzyme. Can rise during heavy training or bone growth.' },
