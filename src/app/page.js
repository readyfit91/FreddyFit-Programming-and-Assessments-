...
const BLOOD_PANELS = [
  {
    ...
    markers: [
      ...
      { name: 'Neutrophils', unit: 'K/µL',  optimal: [1.5,7.8],  borderline: [1.0,1.5],   desc: 'First-responder immune cells. High may signal bacterial infection or chronic inflammation.' },
      { name: 'Lymphocytes', unit: 'K/µL',  optimal: [0.85,3.9], borderline: [0.5,0.85],  desc: 'Viral fighters and memory cells. Low can indicate immune deficiency or overtraining stress.' },
      { name: 'Monocytes',   unit: 'K/µL',  optimal: [0.2,0.95], borderline: [0.95,1.5],  desc: 'Clean up debris and fight chronic infection. Elevated often links to systemic inflammation.' },
      { name: 'Eosinophils', unit: 'K/µL',  optimal: [0.015,0.5],borderline: [0.5,1.5],   desc: 'Respond to allergies and parasites. High may indicate allergic response or inflammation.' },
      { name: 'Basophils',   unit: 'K/µL',  optimal: [0.0,0.2],  borderline: [0.2,0.5],   desc: 'Involved in allergic reactions. Rarely elevated but flags mast cell or allergy issues when high.' },
