...
const OUTREACH_SEQUENCE = [
  { day: 0,  step: 1, channel: 'Text',  emoji: '💬',
    action: '🆕 NEW LEAD — Text them within the hour. A pre-written text is shown below — copy it and send it now. Goal: confirm you got their form and lock in a quick 10-min call to go over their notes and schedule the complimentary consultation.',
                ...
                return (
                  <div key={lead.id} style={{ background: C.faint, border: `2px solid ${step.isOverdue ? C.red + '66' : chCol.border}`, borderRadius: 14, padding: '14px' }}>
                    ...
                    {step.step === 1 && step.day === 0 && (() => {
                      ...
                      const template = `Hey ${firstName}! This is Freddy from FreddyFit 👋 Just got your intake form${lead.goal ? ` — love the ${lead.goal} goal!` : ''} What does your schedule look like today or tomorrow? I'd love to hop on a quick call to go over your notes and get your complimentary consultation scheduled. 💪\n— Freddy | FreddyFit`
                      return (
